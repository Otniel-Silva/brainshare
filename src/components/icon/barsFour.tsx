...
export const BarsFourMini = ({ color = '' }) => (
    <svg className={ color } width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
        <path 
            fillRule="evenodd" 
            clipRule="evenodd" 
...
export const BarsFourOutline = ({ color = '' }) => (
...
export const BarsFourSolid = ({ color = '' }) => (
    <svg className={ color } width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path 
            fillRule="evenodd" 
            clipRule="evenodd" 
